...
switch (operator) {
    ...
    case "Deposit":
        ...
        console.log(`Your Transaction is successfully processed, Now your Total Balance in account is ${amount} Rs`);
        break;
    case "Withdrawl":
        ...
        if (amount >= withdrawlAmount) {
            ...
            console.log("Can not proceed with your transaction, check your balance and try again");
        }
        break;
    default:
